...
<div class="b-dedicated__box">
    <h3 class="b-dedicated__title b-dedicated__title_upline_yes">configurator</h3>
...
<h3 class="b-accordion__title"><span class="b-accordion__title-main">Solution</span><span>Starter</span></h3>
        ...
        <tr class="b-dedicated__accordion-table-row">
            ...
            <td class="b-dedicated__accordion-table-cell js-checked">
                <label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">STARTER</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label><!--
                --><label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">HOSTING</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label><!--
                --><label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">INFRASTRUCTURE</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label><!--
                --><label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">STORAGE</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label><!--
                --><label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">BIGDATA</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label><!--
                --><label class="b-checkbox-submit b-checkbox-submit_size_170">
                    <span class="b-checkbox-submit__text">ENTERPRICE</span>
                    <input class="js-checked-submit" name="check-01" type="radio"/>
                </label>
            </td>
        </tr>
...
<h3 class="b-accordion__title"><span class="b-accordion__title-main">Hardware</span><span>Xeon E3-1230v3 4x3.3GHz</span></h3>
