 ...
 * ConfigCalculator.
 *
 * @package Shop.ConfigCalculator.Model
 ...
 */
class Shop_ConfigCalculator extends Zero_Model
{
    /**
     ...
     * @var string
     */
    protected $Source = 'ConfigCalculator';

    /**
     * Получение всех конфигураций калькулятора
     *
     * @return array
     */
    public static function Get_ConfigCalculatorAll()
    {
        $sql = "SELECT * FROM ConfigCalculator";
     ...
     *
     * @param ConfigCalculator $Model The exact working model
