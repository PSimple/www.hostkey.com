...
<html>
    <head>
        ...
        <title>Hostkey. Managed Cloud</title>
                                ...
                                <table class="b-managed-cloud__result-table">
                                    <tr class="b-managed-cloud__result-table-row">
                                        <td class="b-managed-cloud__result-table-cell">
                                            <div class="b-managed-cloud__result-table-cell-title">CPU cores</div>
                                            <div class="b-managed-cloud__result-table-cell-text">2 cores</div>
                                        </td>
                                        <td class="b-managed-cloud__result-table-cell">
                                            <div class="b-managed-cloud__result-table-cell-title">Ram</div>
                                            <div class="b-managed-cloud__result-table-cell-text">3 008 Mb</div>
                                        </td>
                                        <td class="b-managed-cloud__result-table-cell">
                                            <div class="b-managed-cloud__result-table-cell-title">disk</div>
                                            <div class="b-managed-cloud__result-table-cell-text">80 Gb</div>
                                        </td>
                                        <td class="b-managed-cloud__result-table-cell">
                                            <div class="b-managed-cloud__result-table-cell-title">Traffic: </div>
                                            <div class="b-managed-cloud__result-table-cell-text">2000 Gb</div>
                                        </td>
                                        <td class="b-managed-cloud__result-table-cell">
                                            <div class="b-managed-cloud__result-table-cell-title">Windows License: </div>
                                            <div class="b-managed-cloud__result-table-cell-text">Include</div>
                                        </td>
                                        <td class="b-managed-cloud__result-table-cell b-managed-cloud__result-table-cell_border_no">
                                            <div class="b-managed-cloud__result-table-cell-price">€475.99 / month </div>
                                            <a class="b-submit b-managed-cloud__result-table-cell-submit" href="#">buy</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
