...
angular.module "app.dedicated.step2", [
    "ui"
    "ui.router"
    "api"
]

angular.module("app.dedicated.step2").config ($httpProvider, $stateProvider, $urlRouterProvider) ->
...
angular.module("app.dedicated.step2").controller "AppDedicatedCtrl", ($scope, $rootScope, dedicated) ->
...
angular.module("app.dedicated.step2").filter 'orderVerbose',  ->
    (obj) ->
        str = ""
