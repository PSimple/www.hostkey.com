...
function messager_windows_operator(message, object, status) {
    ...
    switch (status) {
        case 'success':
            object.removeClass('message_pole').addClass('write_message_success');
            break;
        case 'info':
            object.removeClass('message_pole').addClass('write_message_info');
            break;
        case 'error':
            object.removeClass('message_pole').addClass('write_message_error');
            break;
        case 'fatal':
            object.removeClass('message_pole').addClass('write_message_fatal');
            break;
        case 'hide':
            object.addClass('message_pole');
            break;
        case 'show':
            object.removeClass('message_pole');
            break;
        case 'clear':
            object.html('');
            object.removeClassWild("write_message_*");
            break;
        case 'clear+hide' :
            object.html('');
            object.addClass('message_pole');
