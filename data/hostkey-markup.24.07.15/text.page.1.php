...
<html>
    <head>
        ...
        <title>Hostkey. Text. Page 1</title>
        ...
        <style>
            .b-page__promo_text-page_yes {
                background: url(media/promo_text_01.png) no-repeat;
                height: 600px;
            }
        </style>
    ...
    <body>
        ...
        <div class="b-page">
            ...
            <div class="b-page__promo b-page__promo_text-page_yes">
                <h1 class="b-page__promo-title b-page__promo-title_black_yes">
                    Server<br>
                    load<br>
                    balancing
                </h1>
            ...
            <div class="b-text-page">
                ...
                <div class="b-text-page__box">
                    <div class="b-container">
                        <p>
                            We won’t accept your claim/complaint about violation of copyright and associated rights unless made in writing and delivered to us by registered mail.
                        </p>
                        <p>
                        ...
                        <p>
                            All pages of such enclosed copies should be signed and stamped by the applicant company chief executive; or such enclosed copies should be certified by a notary public if the applicant is an individual. The claim/complaint made for and on behalf of
                            a company should be signed and stamped by its chief executive or by any authorized representative acting under the
                            power-of-attorney, the copy of which to be enclosed.
                        </p>
                        <p>
